...
import 'package:lockify/features/fingerprint/manager/fingerprint_cubit.dart';
...
class _FingerprintScreenState extends State<FingerprintScreen> {
  final cubit = FingerprintCubit();

  @override
  void initState() {
    super.initState();
    cubit.getFingerprints();
  }
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocBuilder<FingerprintCubit, FingerprintState>(
          buildWhen: (previous, current) =>
              current is FingerprintStored ||
              current is FingerprintObtained ||
              current is FingerprintDeleted,
          builder: (context, state) {
            return fingerprintItemBuilder();
          },
        ),
  ...
  Widget fingerprintItemBuilder() {
    return ListView.builder(
      physics: const BouncingScrollPhysics(),
      itemCount: cubit.fingerprints.length,
      itemBuilder: (context, index) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text(
                "${S().id} : ${cubit.fingerprints[index].id}",
                maxLines: 1,
                style: TextStyle(
                  fontSize: 18.sp,
                  color: Colors.black,
              ...
              Text(
                "${S().userName} : ${cubit.fingerprints[index].userName}",
                maxLines: 1,
                style: TextStyle(
                  fontSize: 18.sp,
                  color: Colors.black,
              ...
              Text(
                "${S().details} : ${cubit.fingerprints[index].details}",
                maxLines: 1,
                style: TextStyle(
                  fontSize: 18.sp,
                  color: Colors.black,
  ...
  void deleteFingerprintDialog(int index) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return Form(
